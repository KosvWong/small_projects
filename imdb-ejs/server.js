...
app.get('/', (req, res) => {
  ...
  res.render('pages/index', {movies: moviesArray});
...
app.post('/search', function(req,res){
  ...
  for(let i=0; i<moviesArray.length; i++){
       if(moviesArray[i].title.indexOf(searchStr)>=0){
      foundMovies.push(moviesArray[i]);
    }
  }
  res.render('pages/search', {movies: foundMovies});
})
